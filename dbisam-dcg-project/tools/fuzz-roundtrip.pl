...
test_cases(Tests) :-
    Tests = [
        ...
        % --- Bare Bit/Boolean column as a predicate (truth/1) ---
        select_statement(all_rows, [identifier(code)], [table(identifier(t), no_alias)],
            [where(truth(identifier(a)))]),
        select_statement(all_rows, [identifier(code)], [table(identifier(t), no_alias)],
            [where(truth(qualified(identifier(c), identifier(customer))))]),
        select_statement(all_rows, [identifier(code)], [table(identifier(t), no_alias)],
            [where(and(truth(identifier(a)), cmp(gt, identifier(b), integer_literal(0))))]),
        select_statement(all_rows, [identifier(code)], [table(identifier(t), no_alias)],
            [where(not(truth(identifier(a))))]),
        select_statement(all_rows,
            [case_when([when(truth(identifier(a)), string_literal(y))], else(string_literal(n)))],
            [table(identifier(t), no_alias)], []),
        select_statement(all_rows, [identifier(code)], [table(identifier(t), no_alias)],
